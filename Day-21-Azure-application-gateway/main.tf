...
# Step7: Public Ip for Application gateway as Front End IP 
...
#Step 8 : Application Gateway creation
resource "azurerm_application_gateway" "appgtw" {
  ...
  http_listener {
    name                           = "listener-01"
    frontend_ip_configuration_name = "fronend-ip"
    protocol                       = "Http"
  ...
  request_routing_rule {
    name                       = "Rule-01"
    rule_type                  = "Basic"
    http_listener_name         = "listener-01"
